...
public class LoanIntegrationTest {
    ...
    @Test
    public void givenLoanRequestIsMadeLoanApplicationsGetCreated() throws Exception {
        ...
        ResponseEntity<String> response = restTemplate
                .exchange(baseUrl + "/requests", HttpMethod.GET, new HttpEntity(null, getHttpHeaders()), String.class);
       ...
       List<LoanApplicationDTO> loanApplicationDTOS= GSON.fromJson(response.getBody(), new TypeToken<List<LoanApplicationDTO>>(){}.getType());
        ...
        assertEquals(loanApplicationDTOS.get(0).getBorrower().getUsername(),JASON);
    }

    private static HttpHeaders getHttpHeaders() {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.add(HttpHeaders.AUTHORIZATION, JASON);
        return httpHeaders;
    }
}
